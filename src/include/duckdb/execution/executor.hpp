...
DuckDB 采用的是push-based (morsel-driven parallelism: a numa-aware query evaluation framework)
efficiently compiling efficient query plans for modern hardware

tinysql 采用的是pull-based
 */
...
public:
	...
	void CancelTasks();
	// ActiveQueryContext 会通过executro调用这个函数来执行任务
