...
private:
	...
	/*
	auto preparedStmt = clientContext.PrepareStatement("SELECT * FROM users WHERE age > $1");
preparedStmt->Execute(25);  // Execute with age > 25
preparedStmt->Execute(30);  // Execute with age > 30
	*/
