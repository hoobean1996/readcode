...
/*!
  ...
  all expressions.
*/
// Binder可以认为是需要先对SQLStatement做semantic analysis, 然后
// 在成功创建Logical Plan
// 1. Semantic Analysis
// 2. Name Resolution
// 3. Type Checking
// 4. Constraint Checking
// 5. Preparation of Logical Planning
// public enable_shared_from_this<Binder> 用来创建shared_ptr
