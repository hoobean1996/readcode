...
// TableFunction is a class that represents a function that produces a table-like result set. It's a subclass of
// SimpleNamedParameterFunction, which suggests it can take named parameters.
// TableFunction用来产生Table一样的结果
