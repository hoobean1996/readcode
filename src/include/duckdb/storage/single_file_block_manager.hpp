...
// BlockManager: BlockManager is an abstract representation to manage blocks on
// DuckDB. When writing or reading blocks, the
//! BlockManager creates and accesses blocks.
//	- SingleFileBlockManager
// Rely on BufferManager and Block
...
class SingleFileBlockManager : public BlockManager {
  ...
  // 3 headers and then followed up with BLOCKs
