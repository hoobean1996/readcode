...
// GlobalSourceState
// It holds information that needs to be accessible to all parallel execution threads of a particular operator (in this
// case, a table scan).
...
// PhysicalSTableScan::GetData 用来读取数据到chunk中
// OperatorSourceInput 是包含一些有用的筛选信息
